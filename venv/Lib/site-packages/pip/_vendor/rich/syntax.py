...
class Syntax(JupyterMixin):
    ...
    Args:
        ...
        theme (str, optional): Color theme, aka Pygments style (see https://pygments.org/docs/http://127.0.0.1:5000/styles/#getting-a-list-of-available-styles). Defaults to "monokai".
    ...
    def from_path(
        ...
        Args:
            ...
            theme (str, optional): Color theme, aka Pygments style (see https://pygments.org/docs/http://127.0.0.1:5000/styles/#getting-a-list-of-available-styles). Defaults to "emacs".
